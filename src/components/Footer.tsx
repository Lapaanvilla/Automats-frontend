      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold">AutoEats</h2>
            <p className="mt-2 text-gray-300">
              Automate your restaurant operations with WhatsApp integration. Streamline orders, feedback, and table bookings.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/help" className="text-base text-gray-300 hover:text-white">Help Center</Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <p className="text-base text-gray-400">
              &copy; {new Date().getFullYear()} AutoEats. All rights reserved.
            </p>
          </div>
        </div>
      </div>
